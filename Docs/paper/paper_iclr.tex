...
The one open problem, \texttt{spatial\_dropout}, points to spatial-dispersion features and adaptive
neurons as the natural next directions -- a target the theory itself identifies, not one found by
post-hoc search.
