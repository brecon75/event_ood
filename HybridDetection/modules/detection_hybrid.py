...
from models.detection.yolox_extension.models.detector import  YoloXDetectorHybrid
...
class Module_Hybrid(pl.LightningModule):
    def __init__(self, full_config: DictConfig):
        ...
        self.mdl = YoloXDetectorHybrid(self.mdl_config)
    ...
    def training_step(self, batch: Any, batch_idx: int) -> STEP_OUTPUT:
        ...
        for tidx in range(sequence_len):
            ...
            backbone_features, states  = self.mdl.forward_backbone(x=ev_tensors,h_c=prev_states)
