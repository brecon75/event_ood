"""
Training script for the Hybrid detection model.

This script trains the hybrid model on the specified dataset using Hydra configuration.

Usage:
    python train.py +dataset=gen1 +experiment/gen1=small.yaml hardware.gpus=[0]
    python train.py +dataset=gen4 +experiment/gen4=default.yaml hardware.gpus=[0,1,2,3]

The model architecture (hybrid) is selected automatically. Dataset-specific configurations
are applied via experiment configs and dataset overrides.
"""
