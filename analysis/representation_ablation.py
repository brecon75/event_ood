...
def main():
    ...
    print(f"Representation ablation complete. Results saved to {out_dir / 'representation_metrics.csv'} "
          "(paper figures 26/31 are generated by analysis/plot_corruption_graphs.py from this CSV)")
